...
tweets_train, tweets_test, label_train, label_test = train_test_split(tweets_list, label,
                                                                      test_size=0.3,
                                                                      random_state=100,
                                                                      stratify=label)
...
sentences_train_sub, sentences_test_sub, label_train, label_test = train_test_split(sentences_sub,
                                                                                    label,
                                                                                    test_size=0.3,
                                                                                    random_state=100,
                                                                                    stratify=label)
...
model.compile(loss='binary_crossentropy', optimizer=tf.keras.optimizers.Adam(lr=1e-6),
              metrics=METRICS)
...
model_final.compile(loss='binary_crossentropy',
                    optimizer=tf.keras.optimizers.Adam(lr=LEARNING_RATE), metrics=METRICS)
