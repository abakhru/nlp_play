...
"""
Here we will use a large spacy model to calculate document vectors and use it along with
XGBoost for classification of twitter texts
"""
import re
...
X_train, X_test, y_train, y_test = train_test_split(doc_vectors, labels, test_size=0.3,
